...
import {
  ...
  useColorScheme,
  View,
  Image,TouchableOpacity,Button,Alert
} from 'react-native';
...
const OnBoarding: () => Node = ({navigation}) => {
  return (
    ...
    resizeMode: 'contain'}} source={require('./Images/logo.png')} />
         ...
         <Text style={{marginTop:30, marginDown:40,
    color: 'black',
    fontSize: 25,}}>Welcome to Parking Buddy!</Text>
          <Image style={{
    width: 450,
    height: 250,marginTop:30
...
<TouchableOpacity
    ...
    width: 250,
    height: 250,
    resizeMode: 'contain'}} source={require('./Images/Picture1.png')} />
      ...
      >
        ...
        <View style={styles.slide}>
          ...
          width: 250,
          height: 250,
          resizeMode: 'contain'}} source={require('./Images/Picture2.png')} />
      ...
      >
        ...
        <Image style={{          width: 250,
          height: 250,
          resizeMode: 'contain'}} source={require('./Images/firstaidkit.png')} />
         <Text style={styles.text}>Easy Payment</Text>
         <Text style={{}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit</Text>
